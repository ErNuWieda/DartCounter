...
def tm_4_players():
    ...
    return TournamentManager(player_names=players, game_mode="501", system="Doppel-K.o.", shuffle=False)
...
def test_get_next_match_priority(tm_4_players):
    ...
    assert {next_match_after_wb_r1['player1'], next_match_after_wb_r1['player2']} == {"Alice", "Charlie"}, "Next match should be WB final"
