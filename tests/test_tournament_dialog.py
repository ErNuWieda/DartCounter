...
def dialog_setup(tk_root, monkeypatch):
    ...
    mock_settings_manager.get.return_value = ["ProfA", "Guest1"] # für last_tournament_players
...
class TestTournamentSettingsDialog:
    ...
    def test_start_button_collects_data_and_saves_settings(self, dialog_setup):
        ...
        mock_settings_manager.set.assert_called_once_with('last_tournament_players', ["Alice", "Bob"])
    ...
    def test_start_button_shows_error_on_duplicate_names(self, dialog_setup, monkeypatch):
        ...
        mock_showerror.assert_called_once_with("Fehler", "Spielernamen müssen eindeutig sein.", parent=dialog)
