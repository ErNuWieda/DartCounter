...
class MockPlayer:
    ...
    def __init__(self, name, start_score):
        ...
        self.game_name = "301" # Für Statistik-Prüfung
        self.throws = []
        self.sb = MockScoreboard() # Jeder Spieler braucht ein Mock-Scoreboard
        self.state = {'has_opened': True} # Wir nehmen für die meisten Tests an, der Spieler hat bereits eröffnet
        self.stats = {'total_darts_thrown': 0, 'total_score_thrown': 0, 'checkout_opportunities': 0, 'checkouts_successful': 0, 'highest_finish': 0}
