...
class AppSettingsDialog(tk.Toplevel):
    ...
    def _create_sound_settings(self, parent):
        ...
        volume_slider = ttk.Scale(
            sound_frame, from_=0.0, to=1.0, orient=tk.HORIZONTAL,
            variable=self.sound_volume_var, command=self._on_volume_change
        )
    ...
    def _create_ai_settings(self, parent):
        ...
        delay_slider = ttk.Scale(
            ai_frame, from_=250, to=2000, orient=tk.HORIZONTAL,
            variable=self.ai_delay_var, command=self._on_delay_change
        )
