    ...
    def read_json(filepath: Path, parent_for_dialog=None) -> dict | None:
        ...
        try:
            ...
            if parent_for_dialog:
                ui_utils.show_message('error', "Fehler beim Laden", error_msg, parent=parent_for_dialog)
            return None
