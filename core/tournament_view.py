...
class TournamentView(tk.Toplevel):
    ...
    def _setup_double_elim_layout(self, main_frame, finals_frame):
        ...
        self.wb_final_label = ttk.Label(finals_frame, text="", font=("Segoe UI", 12, "bold"), anchor="center")
        self.wb_final_label.pack(pady=(5, 0))

        self.second_place_label = ttk.Label(finals_frame, text="", font=("Segoe UI", 11), anchor="center")
    ...
    def _setup_single_elim_layout(self, main_frame, finals_frame):
        ...
        self.third_place_label = ttk.Label(finals_frame, text="", font=("Segoe UI", 11), anchor="center")
    ...
    def _setup_widgets(self):
        ...
        self.podium_frame.grid(row=0, column=0, rowspan=3, sticky="nsew") # Span over brackets and finals
        ...
        self.podium_labels = {}
        # 2nd Place
        self.podium_labels['second_cup'] = ttk.Label(self.podium_frame, text="🥈", font=("Segoe UI", 48))
        self.podium_labels['second_cup'].grid(row=1, column=0, sticky="s")
        self.podium_labels['second_name'] = ttk.Label(self.podium_frame, text="", font=("Segoe UI", 18, "bold"), foreground="#c0c0c0")
        self.podium_labels['second_name'].grid(row=2, column=0, sticky="n", pady=5)
        # 1st Place
        self.podium_labels['first_cup'] = ttk.Label(self.podium_frame, text="🥇", font=("Segoe UI", 64))
        self.podium_labels['first_cup'].grid(row=0, column=1, sticky="s")
        self.podium_labels['first_name'] = ttk.Label(self.podium_frame, text="", font=("Segoe UI", 22, "bold"), foreground="#ffd700")
        self.podium_labels['first_name'].grid(row=1, column=1, sticky="n", pady=5)
        # 3rd Place
        self.podium_labels['third_cup'] = ttk.Label(self.podium_frame, text="🥉", font=("Segoe UI", 40))
        self.podium_labels['third_cup'].grid(row=2, column=2, sticky="s")
        self.podium_labels['third_name'] = ttk.Label(self.podium_frame, text="", font=("Segoe UI", 16, "bold"), foreground="#cd7f32")
    ...
    def _update_double_elim_view(self, next_match, wb_bracket_winner):
        ...
        self.losers_canvas.draw_bracket(losers_rounds, next_match, lb_bracket_winner, bracket_type="losers")
    ...
    def update_bracket_tree(self):
        ...
        self.winners_canvas.draw_bracket(winners_rounds, next_match, wb_bracket_winner, bracket_type="winners")
