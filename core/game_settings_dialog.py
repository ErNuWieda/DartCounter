...
class GameSettingsDialog(tk.Toplevel):
            ...
            "x01_options": [
                {
                    ...
                    "variable": self.opt_in_var,
                },
                {
                    "label": "Opt Out",
                    "values": ["Single", "Double", "Masters"],
                    "variable": self.opt_out_var,
                },
                {
                    "label": "Legs pro Satz",
                    "values": ["1", "3", "5"],
                    "variable": self.legs_to_win_var,
                },
                {
                    "label": "Sätze pro Match",
                    "values": ["1", "3", "5"],
                    "variable": self.sets_to_win_var,
                },
            ],
            "atc_options": [
                {
                    "label": "Around The Clock Variante",
                    "values": ["Single", "Double", "Triple"],
                    "variable": self.opt_atc_var,
                },
            ],
            "elimination_options": [
                {
    ...
    def _on_start(self):
        ...
        self.result = {"game": self.game_var.get(), "players": player_names}
    ...
    def _create_players_frame(self, parent, row):
        ...
        self.player_select = ttk.Combobox(
            players_frame,
    ...
    def _update_available_profiles(self, event=None):
        ...
        selected_names = {
            ...
            if entry and entry.cget("state") != "disabled" and entry.get()
        }
        ...
        for entry in self.player_name_entries:
            if entry and entry.cget("state") != "disabled":  # Die Prüfung ist hier korrekt
                ...
                available = [
                    ...
                    if name not in selected_names or name == current_value
                ]
    ...
    def _create_game_selection_frame(self, parent, row):
        ...
        ttk.Label(self.game_selection_frame, text="Spiel:").grid(
